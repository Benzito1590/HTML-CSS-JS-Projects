...
suite("Unit Tests", () => {
  ...
  suite("Function americanToBritish() and britishToAmerican()", () => {
    suite("American to British English", () => {
      test("Mangoes are my favorite fruit. --> Mangoes are my favourite fruit.", done => {
        ...
        const { americanToBritish } = require("../public/translator");
        assert.equal(output, americanToBritish(input));
        done();
      }); 

      test("I ate yogurt for breakfast. --> I ate yoghurt for breakfast.", done => {
        const input = "I ate yogurt for breakfast.";
        const output = "I ate yoghurt for brekky.";
        const { americanToBritish } = require("../public/translator");
        assert.equal(output, americanToBritish(input));
        done();
      });
    ...
    suite("British to American English", () => {
      test("We watched the footie match for a while. --> We watched the soccer match for a while.", done => {
        ...
        const { britishToAmerican } = require("../public/translator");
        assert.equal(output, britishToAmerican(input));
        done();
      });
